...
<header class="flex h-[64px] flex-none items-center gap-3 border-b border-line bg-header px-4 md:h-[72px] md:gap-[18px] md:px-[26px]">
    ...
    <div class="min-w-0">
        <h1 class="truncate font-serif text-[19px] font-semibold leading-tight text-ink-strong md:text-[27px] md:leading-[1.05]">{{ $title ?? (($brandName ?? 'Aterra Realty').' CRM') }}</h1>
