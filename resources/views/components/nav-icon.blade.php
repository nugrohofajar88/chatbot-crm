...
@switch($name)
    ...
    @case('cog')
        ...
        @break
    @case('megaphone')
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><path d="M3 11l15-6v14l-15-6z"/><path d="M3 11v3a2 2 0 0 0 2 2h2"/><path d="M8 16v3a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-2"/></svg>
        @break
    @case('sliders')
