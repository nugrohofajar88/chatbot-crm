...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    private const MAP = [
        ...
        'META_MESSENGER_COMMENT_PUBLIC_REPLY' => 'services.meta.messenger_comment_public_reply',
    ...
    private const BOOLS = [
        'META_MESSENGER_ENABLED', 'META_MESSENGER_COMMENTS_ENABLED', 'META_MESSENGER_COMMENT_PUBLIC_REPLY',
